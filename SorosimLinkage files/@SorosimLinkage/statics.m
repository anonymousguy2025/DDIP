...
options = optimoptions('fsolve','Algorithm','levenberg-marquardt','Display','iter','MaxFunctionEvaluations',2e10);%,'Jacobian','on'); 'trust-region-dogleg' (default), 'trust-region', and 'levenberg-marquardt'.
tic
