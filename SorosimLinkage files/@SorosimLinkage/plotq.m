        ...
        for ii=1:n_l-1
            ...
            if ~isempty(q_here)
                if strcmp(Type,'FEM Like')
                    ...
                    xi_Zhere  = xi_Zhere+diag([1/Lscale 1/Lscale 1/Lscale 1 1 1])*Bh(X_Z,Bdof,Bodr,SubClass)*q_here;
                elseif strcmp(Type,'Custom Independent')
                    xi_Zhere  = xi_Zhere+diag([1/Lscale 1/Lscale 1/Lscale 1 1 1])*Bh(X_Z)*q_here;
                else
                    xi_Zhere  = xi_Zhere+diag([1/Lscale 1/Lscale 1/Lscale 1 1 1])*Bh(X_Z,Bdof,Bodr)*q_here;
                end
            end
